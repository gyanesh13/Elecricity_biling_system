...
public class GenerateBill extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        try 
        {
           ...
           t1.setText("\t Reliance Power Limited \n ELECTRICITY BILL FOR THIS MONTH" +month+",2021\n\n\n");
            ResultSet rs=cc.s.executeQuery("select * from customer where meter="+meter);
            ...
            rs=cc.s.executeQuery("select * from meter_info where meter_number= "+ meter);
            ...
            rs=cc.s.executeQuery("select * from tax");
            if(rs.next())
            {
                t1.append("\n -----------------------------------------------");
                t1.append("\n\n");
                ...
                rs=cc.s.executeQuery("select * from bill where meter ="+meter+" AND month ='"+c2.getSelectedItem()+"'");
