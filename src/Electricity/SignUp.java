...
public class SignUp extends JFrame implements ActionListener
{
    ...
    JButton b1,b2;
     ...
     { 
         ...
         p1.setForeground(new Color(39,139,34)); 
    ...
    public void actionPerformed(ActionEvent ae) {
         if(ae.getSource()==b1)
         {
             ...
             try 
             {
                  ...
                  {
                      str="insert into login values('"+meter+"','"+name+"','"+username+"','"+password+"','"+user+"')";
                  }
                  else{
                       str="update login set username='"+username+"', name='"+name+"', password='"+password+"', user='"+user+"' where meter_number='"+t4.getText()+"'";   
                  }
